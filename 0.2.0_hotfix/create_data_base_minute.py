...
class StockChart:
    ...
    def call_stock_data_minute_tick(self, peroid, todaystamp=0):
        ...
        ## 날짜와 분봉의 합치
        receive_data['Date'] = list(map(lambda x, y: int('{}{:05}'.format(x, y)), receive_data['Date'], receive_data['Time']))
...
class ExportDatabase:
    ...
    def MakeDatabase(self):
        ...
        code_list = ['A233740', 'A229200', 'A251340', 'A069500', 'A122630', 'A114800', 'A252670']
