...
class CpStockChart:
    def __init__(self):
        ...
        self.CpSvr7238 = win32com.client.Dispatch("CpSysDib.CpSvr7238")
    ...
    # 차트 요청 - 최근일 부터 개수 기준
    @check_PLUS_status
    def RequestDWM(self, code, dwm='일', count, from_date=0):
        """
        :param code: 종목코드
        ...
        self.objStockChart.SetInputValue(5, [0, 2, 3, 4, 5, 8, 9])  # 요청항목 - 날짜, 시가, 고가, 저가, 종가, 거래량, 거래대금
        self.objStockChart.SetInputValue(6, dwm)  # '차트 주기 - 일/주/월
        self.objStockChart.SetInputValue(9, ord('1'))  # 수정주가 사용

        self.CpSvr7238.SetInputValue(0, code)
